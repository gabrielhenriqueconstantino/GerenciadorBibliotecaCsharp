    ...
    class Program // Define a classe principal do programa.
    {
        static void Main(string[] args) // Ponto de entrada do programa. Método obrigatório para iniciar a aplicação.
        {
            ...
            while (true) // Loop infinito para manter o menu ativo até que o usuário escolha sair.
            {
                ...
                Console.WriteLine("8. Cadastrar novo livro"); //Cadastrar livro novo
                Console.WriteLine("9. Remover livro por ISBN"); // Nova opção para remover livro
                ...
                switch (opcao) // Verifica a opção escolhida.
                {
                    ...
                    case "8":
                        ...
                        biblioteca.CadastrarLivro(new Livro(titulo, autor, ano, novoIsbn));
                        Console.WriteLine("Livro cadastrado com sucesso!");
                        break;
                    case "9":
                        Console.Write("ISBN do livro a ser removido: ");
                        string isbnRemover = Console.ReadLine();

                        bool removido = biblioteca.RemoverLivro(isbnRemover);
                        if (removido)
